...
class iceBearSpider(scrapy.Spider):
    ...
    start_urls = ["https://icebear.me/job"]
    headers = {
    ...
    cookies = {
        "session_login_token_login_info": "bfAUQ3TXwfxUAJwnpD4pwkOwwT-CZI4aWfmM-b184CfKzCjF2nzbyCcxtvPbxXEF6iMTT6c3r5k16o5AnwqCsfKqoDhNdoUbnpKS8rWmXeGiFxxJtedC5flU60xPao4FMjqs-m-8jsUxZO0c6VVPOjd-apW5cFjbLiM3-fjpJUqJ4RaxhfNFQx1NpOtKX1PyVn2kumLe73Al3bLfvkd4kChVAeiJbDp6aaifkSymV26ydIMS9h6xGZmDUBYs8Bb4uHh8wgdAYFB0MtnHTCIPNHgWhKtXRVIgDmpqQ3iSjC7tZ7RguZ6Fiqik-dMi-uP31aL7VRPpqsEudm4GmhOmp9fz6S5s6MAXNvjZstNHMBmZZotNwCFUtDW15Yx0ZAxoZDrsyGcJxAbXhaTwMbDckaxLFCSBLjHyYSI9Z5upAIvk0RpkuSeyz4a9Lzks0klsO2s8EHy1xS0"}

    data = {
        "filter": "0!0!0!0!0!1!!1",
        "page": 1
    }

    data_str = "filter=0!0!0!0!0!1!!1&page=3"
    ...
    def parse(self, response):
        print(response.text)
        result_json = json.loads(response.text, encoding="utf-8")
        print(result_json)
        for li in result_json["data"]["list"]:
            item = IcebearItem()
            item['company_name'] = li["companyName"]
            item['post_category'] = li["posiType"]
            item['city'] = li["cityType"]
            item['href'] = self.host + li["url"]
            print(item['href'])
            # 详情
